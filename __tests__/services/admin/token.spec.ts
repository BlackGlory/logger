...
describe('TBAC', () => {
  describe('GET /admin/logger-with-tokens', () => {
    describe('auth', () => {
      it('200', async () => {
  ...
  describe('GET /admin/logger/:namespace/tokens', () => {
    describe('auth', () => {
      it('200', async () => {
        process.env.LOGGER_ADMIN_PASSWORD = 'password'
  ...
  describe('PUT /admin/logger/:namespace/tokens/:token/write', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.LOGGER_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('DELETE /admin/logger/:namespace/tokens/:token/write', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.LOGGER_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('PUT /admin/logger/:namespace/tokens/:token/read', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.LOGGER_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('DELETE /admin/logger/:namespace/tokens/:token/read', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.LOGGER_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('PUT /admin/logger/:namespace/tokens/:token/delete', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.LOGGER_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
  ...
  describe('DELETE /admin/logger/:namespace/tokens/:token/delete', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.LOGGER_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
